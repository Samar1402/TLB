    ...
    <div className="p-6">
      <div className="flex flex-col md:flex-row  border rounded-xl shadow-md p-6 justify-evenly bg-gradient-to-r from-slate-950 to-yellow-200">
        <div className="flex flex-col gap-10">
          ...
          <button className="border-black bg-teal-700 text-white px-6 py-2 rounded-2xl w-36 h-14 justify-center font-semibold transition-transform duration-200 transform hover:scale-105">
            ORDER NOW
          </button>
        </div>
